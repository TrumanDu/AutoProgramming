### AutoProgramming智能开发平台
当前最新版本：1.1
 
### 简介
AutoProgramming是在[jeeidp](http://git.oschina.net/liuzhenjn/jeeidp)（Java EE Intelligent development platform）基础之上的代码生成器的智能开发平台。采用智能生成+手动调整的开发模式，帮助开发人员解决50%的工作量，大大提高了开发人员的效率，为公司节约了成本，同时还很方便快捷。

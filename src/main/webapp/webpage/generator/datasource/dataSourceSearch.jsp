...
<div class="col-md-12">
	<div class="panel-search">
	  <form class="form-inline" action="/dataSource/list">
	    <div class="form-group">
	      <label class="control-label">连接名称：</label>
	      <input type="text" class="form-control" id="description" name="description" placeholder="连接名称">
	    </div>
	    <div class="form-group">
	      <label class="control-label">数据库名称：</label>
	      <input type="text" class="form-control" id="databaseName" name="databaseName" placeholder="数据库名称">
	    </div>
	  </form>
	  <div class="btn-div">
			<div class="div-left">
				<button type="button" class="btn btn-warning" onclick="add('/dataSource/dataSource')">

...
<head>
	...
	<link href="${webRoot}/static/admin/layout3/css/layout.css" rel="stylesheet" type="text/css"/>
	<link href="${webRoot}/static/admin/layout3/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color"/>
	<link href="${webRoot}/static/admin/layout3/css/custom.css" rel="stylesheet" type="text/css"/>
	<!-- END THEME STYLES -->
</head>
...
<!-- END FOOTER -->	
	...
	<script src="${webRoot}/static/admin/layout3/scripts/layout.js" type="text/javascript"></script>
	<script src="${webRoot}/static/admin/layout3/scripts/demo.js" type="text/javascript"></script>

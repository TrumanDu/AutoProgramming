...
<head>
	...
	<link href="${webRoot}/static/global/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css" rel="stylesheet" type="text/css"/>
	<link href="${webRoot}/static/global/plugins/fullcalendar/fullcalendar.min.css" rel="stylesheet" type="text/css"/>
	...
	<link href="${webRoot}/static/admin/layout2/css/layout.css" rel="stylesheet" type="text/css"/>
	<link href="${webRoot}/static/admin/layout2/css/themes/grey.css" rel="stylesheet" type="text/css" id="style_color"/>
	<link href="${webRoot}/static/admin/layout2/css/custom.css" rel="stylesheet" type="text/css"/>
	<!-- END THEME STYLES -->
</head>
...
<!-- END FOOTER -->	
	...
	<script src="${webRoot}/static/global/plugins/bootstrap-daterangepicker/moment.min.js" type="text/javascript"></script>
	<script src="${webRoot}/static/global/plugins/bootstrap-daterangepicker/daterangepicker.js" type="text/javascript"></script>
	<!-- IMPORTANT! fullcalendar depends on jquery-ui.min.js for drag & drop support -->
	<script src="${webRoot}/static/global/plugins/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
	...
	<script src="${webRoot}/static/admin/layout2/scripts/layout.js" type="text/javascript"></script>
	<script src="${webRoot}/static/admin/layout2/scripts/demo.js" type="text/javascript"></script>
